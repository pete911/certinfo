...
var idKpOIDs = map[string]string{
	...
	"1.3.6.1.5.5.7.3.30": "bgp sec router",
	"1.3.6.1.5.5.7.3.31": "brand indicator for message identification",
	"1.3.6.1.5.5.7.3.32": "cm KGA",
	"1.3.6.1.5.5.7.3.33": "rpc TLS client",
	"1.3.6.1.5.5.7.3.34": "rpc TLS server",
	"1.3.6.1.5.5.7.3.35": "bundle security",
	"1.3.6.1.5.5.7.3.36": "document signing",
	"1.3.6.1.5.5.7.3.37": "jwt",
	"1.3.6.1.5.5.7.3.38": "http content encrypt",
	"1.3.6.1.5.5.7.3.39": "oauth access token signing",
}
